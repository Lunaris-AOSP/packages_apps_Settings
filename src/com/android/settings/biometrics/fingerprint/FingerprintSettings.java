...
public class FingerprintSettings extends SubSettings {
    ...
    public static class FingerprintSettingsFragment extends DashboardFragment
        ...
        private void addFingerprintPreferences(PreferenceGroup root) {
            ...
            if ((!isUdfps() && mFingerprintWakeAndUnlock) ||
                    (screenOffUnlockUdfps() && (isUltrasnoicUdfps() || (isUdfps() && !TextUtils.isEmpty(mUdfpsLongPressSensorType))))) {
        ...
        private void addFingerprintUnlockCategory() {
            ...
            } else if (screenOffUnlockUdfps() && (isUltrasnoicUdfps() || (isUdfps() && !TextUtils.isEmpty(mUdfpsLongPressSensorType)))) {
